...
# Install python dev environment. Some packages (like jsonnet) need it to install properly.
sudo yum install -y python3-devel  

# Upgrade pip
/home/opc/mlenv/bin/python3 -m pip install --upgrade pip
...
# Install spacy -- spacy-lookups are for lemmatization
pip install spacy
...
# If there is a rquirements.txt, use it
requirementsFile=~/repo/requirements.txt
if test -f "$requirementsFile"; then
  pip install -r $requirementsFile
else
  echo "No $requirementsFile in repo to install."
fi

touch /home/opc/completed.requirements

touch /home/opc/completed.all
